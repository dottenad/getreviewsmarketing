...
const SupportIndex = () => (
  <div>
    <Head>
      <title>FTP - GetReviews.ai</title>
      <meta
        name="description"
        content="Learn how to enable and configure the FTP integration here"
      />
    </Head>
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
              <div className="text-lg max-w-prose mx-auto">
                ...
                <p className="mt-8 text-xl leading-8">
                  The FTP integration allows you to upload your survey responses
                  to a remote server.
                </p>
                <img
                  className="w-full my-8"
                  src="../../../../ftp_instructions.png"
                  alt="FTP"
                />
              </div>
              <div className="mt-6 prose prose-lg mx-auto text-gray-900">
                <ol>
                  ...
                  <li>
                    <strong>Host</strong>: Enter the host name for the server
                    you would like to upload your survey responses to
                  </li>
                  <li>
                    <strong>Username</strong>: Enter the username for the server
                    you would like to upload your survey responses to
                  </li>
                  <li>
                    <strong>Password</strong>: Enter the password for the server
                    you would like to upload your survey responses to
                  </li>
                  <li>
                    <strong>Directory</strong>: Enter the directory you would
                    like to upload survey responses to. This is relative to the
                    root of the server (i.e. &quot;/&quot; would indicate that
                    you would like to upload survey responses to the root of the
                    server.)
                  </li>
                </ol>
