                    ...
                    <div class="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:gap-px">
                                ...
                                <div class="flex items-center space-x-5">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-medium">
                                            <a href="/support/getting-started/platforms" class="focus:outline-none">
                                                <span class="absolute inset-0" aria-hidden="true"></span>
                                                Platforms
                                            </a>
                                        </h3>
                                        <p class="mt-2 text-sm text-gray-500">
                                            Platforms are the websites that you would like to collect reviews on. Learn how to configure them here.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                            <div class="flex items-center space-x-5">
                                ...
                                <div>
                                    <h3 class="text-lg font-medium">
                                        <a href="/support/getting-started/giveaways" class="focus:outline-none">
                                            <span class="absolute inset-0" aria-hidden="true"></span>
                                            Giveaways
                                        </a>
                                    </h3>
                        ...
                        <div class="relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                            <div class="flex items-center space-x-5">
                                ...
                                <div>
                                    <h3 class="text-lg font-medium">
                                        <a href="/support/getting-started/products" class="focus:outline-none">
                                            <span class="absolute inset-0" aria-hidden="true"></span>
                                            Products
                                        </a>
                                    </h3>
                        ...
                        <div class="rounded-bl-lg rounded-br-lg relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                            <div class="flex items-center space-x-5">
                                ...
                                <div>
                                    <h3 class="text-lg font-medium">
                                        <a href="/support/getting-started/surveys" class="focus:outline-none">
                                            <span class="absolute inset-0" aria-hidden="true"></span>
                                            Surveys
                                        </a>
                                    </h3>
