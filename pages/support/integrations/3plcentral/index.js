                        ...
                        <ol role="list" className="flex items-center space-x-4">
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <a href="/support/integrations" className="ml-4 text-sm font-medium hover:text-gray-700">Integrations</a>
                                </div>
                            </li>
                    ...
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            <div className="text-lg max-w-prose mx-auto">
                                <h1>
                                    <span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">3PL Central</span>
                                </h1>
                                <figure>
                                    <img className="w-full my-8" src="../../../features_platforms.svg" alt="" width="1310" height="873" />
                                </figure>
                                <p className="mt-8 text-xl leading-8">Platforms and marketplaces in GetReviews are the places where you would like to collect reviews. For example, if you sell products on Amazon and Walmart and wanted to collect reviews on Amazon and Walmart, you would enable both of these marketplaces on GetReviews. If you sell your services such as real estate brokering or plumbing services and wanted to collect reviews on Google or Facebook, you would enable these platforms on GetReviews.</p>
                            </div>
