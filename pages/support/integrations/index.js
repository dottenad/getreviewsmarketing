...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta
        name="description"
        content="Automate your dataflow utilizing GetReviews' integration library"
      />
    </Head>
            ...
            <div className="flex items-center space-x-5">
              <div className="flex-shrink-0">
                <div className="relative">
                  <span className="rounded-lg inline-flex p-8 bg-sky-50 text-gray-900 ring-4 ring-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-16 w-16 text-sky-700"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/overview"
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Familiarize yourself with how integrations work within
                  GetReviews
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/sheets"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/klaviyo"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/mailchimp"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/shipbob"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/shiphero"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/integrations/tremendous"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
