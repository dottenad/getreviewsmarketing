...
const SupportIndex = () => (
  <div>
    <Head>
      <title>Gift Card/eGift - GetReviews.ai</title>
      <meta name="description" content="The Gift Card/eGift giveaway type enables you to send your customer either a physical or a digital gift card" />
    </Head>
                        ...
                        <li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <Link passHref href="/support/getting-started/giveaways"><a className="ml-4 text-sm font-medium text-gray-700 hover:text-gray-900">Giveaways</a></Link>
                                </div>
                            </li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 text-sm font-medium text-gray-500">Gift Card/eGift</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <blockquote>
                                ...
                                <ol role="list">
                                    <li>On the <a href="https://app.getreviews.ai/giveaway" target="_blank" rel="noreferrer" className="underline">giveaways</a> page, click &quot;Add Giveaway&quot; and then select &quot;eGift.&quot;<br />
