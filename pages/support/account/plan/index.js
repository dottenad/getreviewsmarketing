...
const SupportIndex = () => (
  <div>
    <Head>
      <title>Plan/Billing - GetReviews.ai</title>
      <meta
        name="description"
        content="Learn more about how billing works on GetReviews here"
      />
    </Head>
              ...
              <div className="flex items-center space-x-5">
                ...
                <div>
                  <h3 className="text-lg font-medium">
                    <Link
                      passHref
                      href="/support/account/plan/select"
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Select which plan you would like to sign up for on
                    GetReviews.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/account/plan/change-plan"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/account/plan/card-management"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-lg font-medium">
                  <Link
                    passHref
                    href="/support/account/plan/cancel"
                    className="focus:outline-none"
                  >
                    <a>
                      <span
