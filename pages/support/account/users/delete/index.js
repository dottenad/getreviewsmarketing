...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Learn how to delete a user from your GetReviews account here." />
    </Head>
                        ...
                        <li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 text-sm font-medium text-gray-500">Delete User</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            <div className="text-lg max-w-prose mx-auto">
                                <h1>
                                    <span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Delete User</span>
                                </h1>
                            </div>
