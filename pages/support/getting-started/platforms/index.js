                        ...
                        <ol role="list" className="flex items-center space-x-4">
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <Link passHref href="/support/getting-started" className="ml-4 text-sm font-medium hover:text-gray-700"><a>Getting Started</a></Link>
                                </div>
                            </li>
                    ...
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            <div className="text-lg max-w-prose mx-auto">
                                ...
                                <figure>
                                    <img className="w-full my-8" src="../../../platforms_and_marketplaces.svg" alt="" width="1310" height="873" />
                                </figure>
