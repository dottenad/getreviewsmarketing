...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Learn how to enable and configure the Tremendous integration here" />
    </Head>
                    ...
                    <div className="rounded-tl-lg rounded-tr-lg relative group bg-white py-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-6 prose prose-lg prose-sky mx-auto text-gray-900">
                                ...
                                <ol>
                                    <li><a href="https://www.tremendous.com/refer/2berr" target="_blank" rel="noreferrer" className="underline">Sign up</a> for a Tremendous.com account</li>
                                    <li>Once signed up, <strong>(1)</strong> click &quot;Campaign Templates&quot; in the left navigation, then <strong>(2)</strong> click &quot;Create&quot;
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_1.jpg" alt="" />
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_2.jpg" alt="" />
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_3.jpg" alt="" />
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_5.jpg" alt="" />
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_6.jpg" alt="" />
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_10.jpg" alt="" />
                                ...
                                <ol>
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_7.jpg" alt="" />
                                ...
                                <ol>
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_8.jpg" alt="" />
                                        <figcaption>Generate API Key</figcaption>
                                    </figure>
                                    </li>
                                    <li>Copy API Key
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_9.jpg" alt="" />
                                ...
                                <ol>
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_11.jpg" alt="" />
                                ...
                                <ol>
                                    ...
                                    <figure className="mt-4">
                                        <img className="w-full rounded-lg border border-gray-200" src="../../../tremendous_13.jpg" alt="" />
                                    ...
                                    <Link passHref href="/support/getting-started/giveaways/giftcard"><a><button type="button" className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
