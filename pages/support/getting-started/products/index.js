...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="A product is what the customer purchased from you. Learn how to add and configure products on GetReviews here" />
    </Head>
                    ...
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-10 prose prose-sky prose-lg mx-auto">
                                ...
                                <ol role="list">
                                    <li>On the <a href="https://app.getreviews.ai/product" target="_blank" rel="noreferrer" className="underline">products</a> page, click &quot;Add Product&quot;<br />
