        ...
        return (
          ...
          <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            ...
            <div class="px-5 py-2">
              ...
              <div class="px-5 py-2">
                <a href="https://supernutritionco.com/" target="_blank" class="text-base text-gray-500 hover:text-gray-900">
                  Demo
                </a>
              </div>

              <div class="px-5 py-2">
                <a href="https://app.getreviews.ai/signup" target="_blank" class="text-base text-gray-500 hover:text-gray-900">
                  Sign Up
                </a>
              </div>
            </nav>
