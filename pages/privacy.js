                    ...
                    <div className="relative px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-10 prose prose-sky prose-lg mx-auto">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to GetReviews.ai, accessible from <a href="https://getreviews.ai/" rel="external nofollow noopener" target="_blank">https://getreviews.ai/</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    <p>By email: <Link passHref href="mailto:info@getreviews.ai"><a>info@getreviews.ai</a></Link></p>
                                </li>
                            </ul>
                        </div>
                    </div>
