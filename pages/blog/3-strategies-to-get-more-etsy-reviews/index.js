...
const SiteIndex = () => (
  <div>
    <Head>
      ...
      <meta
        name="description"
        content="Learn the top 3 tactics professional Etsy sellers are using to get more customer reviews"
      />
      <meta property="og:type" content="article" />
      <meta
        property="og:title"
        content="3 Strategies To Get More Etsy Reviews"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://www.getreviews.ai/blog/3-strategies-to-get-more-etsy-reviews/main.jpg"
      />
      <meta
        property="og:url"
        content="https://www.getreviews.ai/blog/3-strategies-to-get-more-etsy-reviews"
      />
          ...
          <div className="relative pb-16 bg-white overflow-hidden">
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
              <div className="prose prose-sky prose-lg mx-auto">
                ...
                <p className="mt-0">
                  When first starting out on Etsy, it can be hard to get
                  momentum. The sight of 0 reviews can be very defeating, and
                  could be what is causing low or no sales on your Etsy store.
                  This makes it all the more important to go above and beyond
                  with customer service once you do make a sale. Only once your
                  customers expectations of their purchase from your store have
                  been met can they begin to think about the overall experience
                  with your brand and your product. Your customer will take
                  everything into consideration when going to leave a review on
                  your store. Price, shipping time, quality, etc., so it is
                  important to make sure you tick all of these boxes to ensure
                  you get a good review from your customer. However, you could
                ...
                <p>
                  ...
                  <blockquote>
                    <p>
                      Thank you for your purchase! If you enjoyed your
                      experience with our store and our products, feel free to
                ...
                <p>
                  ...
                  should see is this insert card. You may be asking, why would I
                  give my customer a free gift? What do I get out of it? This is
                  where our product,{" "}
                  <Link href="https://www.getreviews.ai/" passHref>
                    <a>GetReviews.ai</a>
                  </Link>{" "}
                ...
                <p>
                  When first starting out, it is important to go to great
                  lengths to ensure that your customer has a good experience
                  with your product. Follow up emails are a great way to do
                ...
                <p className="mt-12">
                  I hope this post helped shine some light on the different
                  review generation methods used by top Etsy sellers. If you
                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    ...
                    <img
                      className="h-12 w-12 rounded-full mt-8 mb-8"
                      src="/_blog/dan.jpg"
                      alt="Dan Ottenad"
                    />
                  </div>
