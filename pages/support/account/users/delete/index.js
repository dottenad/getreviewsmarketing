...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta
        name="description"
        content="Learn how to delete a user from your GetReviews account here."
      />
    </Head>
        ...
        <div className="relative py-16 bg-white overflow-hidden">
          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 prose prose-sky prose-lg mx-auto">
              <p>
                To delete a user from your GetReviews account, click the
              ...
              <p>
                Once on the Users page, locate the user you would like to
                delete, and then click the trash can icon next to their name.
              </p>
              <figure className="mt-4">
                <img
                  className="rounded-lg border border-gray-200 mx-auto"
                  src="../../../account_users_5.jpg"
                  alt="Click the trash can icon to delete user"
                />
