...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Learn more about user administration on GetReviews here." />
    </Head>
                ...
                <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:gap-px">
                            ...
                            <div className="flex items-center space-x-5">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium">
                                        <Link passHref href="/support/account/users/add" className="focus:outline-none"><a>
                                            <span className="absolute inset-0" aria-hidden="true"></span>
                                            Add User
                                        </a></Link>
                                    </h3>
                                    <p className="mt-2 text-sm text-gray-500">
                                        Learn how to add a user to your GetReviews account here.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                        <div className="flex items-center space-x-5">
                            ...
                            <div>
                                <h3 className="text-lg font-medium">
                                    <Link passHref href="/support/account/users/delete" className="focus:outline-none"><a>
                                        <span className="absolute inset-0" aria-hidden="true"></span>
                                        Delete User
                                    </a></Link>
                                </h3>
                                <p className="mt-2 text-sm text-gray-500">
                                    Learn how to delete a user from your GetReviews account here.
                                </p>
                            </div>
                        </div>
                        <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    ...
                    <div className="rounded-bl-lg rounded-br-lg relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                        <div className="flex items-center space-x-5">
                            ...
                            <div>
                                <h3 className="text-lg font-medium">
                                    <Link passHref href="/support/account/users/change" className="focus:outline-none"><a>
                                        <span className="absolute inset-0" aria-hidden="true"></span>
                                        Change User Permissions
                                    </a></Link>
                                </h3>
                                <p className="mt-2 text-sm text-gray-500">
                                    Learn how to change user permissions for users on your GetReviews account here.
                                </p>
                            </div>
                        </div>
                        <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
