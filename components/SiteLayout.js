            ...
            >
                <div className="flex items-center flex-1">
                    ...
                    <div className="hidden md:block md:ml-10 md:space-x-10">
                        {nav.map((item) => (
                            <Link passHref key={item.name} href={item.href} target={item.target}><a>
                ...
                <div className="hidden md:block text-right">
                    <span className="inline-flex mr-2">
                        <Link passHref href="https://app.getreviews.ai/login"><a>
                    ...
                    <span className="inline-flex rounded-md shadow-md ring-1 ring-black ring-opacity-5">
                        <Link passHref href="https://app.getreviews.ai/signup"><a>
                ...
                >
                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            {nav.map((item) => (
                                <Link passHref key={item.name} href={item.href}><a>
        ...
        <footer className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                    ...
                    <div className="px-5 py-2">
                        <Link passHref href="/integrations"><a>
                            <div className="text-base text-gray-500 hover:text-gray-900">
                                Integrations
                            </div>
                        </a></Link>
                    ...
                    <div className="px-5 py-2">
                        <Link passHref href="https://supernutritionco.com/" target="_blank"><a>
                            <div className="text-base text-gray-500 hover:text-gray-900">
                                Demo
                            </div>
                        </a></Link>
                    ...
                    <div className="px-5 py-2">
                        <Link passHref href="/support" target="_blank"><a>
                            <div className="text-base text-gray-500 hover:text-gray-900">
                                Knowledge Base
                            </div>
                        </a></Link>
                    ...
                    <div className="px-5 py-2">
                        <Link passHref href="https://app.getreviews.ai/signup" target="_blank" ><a>
                            <div className="text-base text-gray-500 hover:text-gray-900">
                                Sign Up
                            </div>
                        </a></Link>
