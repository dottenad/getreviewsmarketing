...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="The Coupon Code giveaway type is a digital coupon that is emailed to your customer upon survey completion" />
    </Head>
                        ...
                        <li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 text-sm font-medium text-gray-500">Coupon Code</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
