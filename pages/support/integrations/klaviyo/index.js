...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta
        name="description"
        content="Learn how to enable and configure the Klaviyo integration here"
      />
    </Head>
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
              <div className="mt-6 prose prose-lg mx-auto text-gray-900">
                ...
                <p className="mt-8 text-xl leading-8 mb-8">
                  Automatically export all GetReviews respondents to Klaviyo.
              ...
              <div className="mt-6 prose prose-lg prose-sky mx-auto text-gray-900">
                ...
                <ol>
                  ...
                  <li>
                    Locate your private API key - this should look like:{" "}
                    <strong>pk_257d2eeaeb5284daceba5211270a81e451</strong> (if
                    you do not see your private API key, click the blue
                ...
                <p className="mb-0">
                  The List ID is where you would like GetReviews to send your
                  respondent data to.
                </p>
                <ol>
                  <li>
                  ...
                  <li>
                    ...
                    &nbsp;&nbsp;icon on the right side of the list and then
                    click &quot;List Settings&quot;
                  </li>
                  <li>
                    Your list&apos;s ID will be near the top of this screen (see
                    image below)
                ...
                <ol>
                  ...
                  <li>
                    Locate the Klaviyo integration and click
                    &quot;Configure&quot;
                  </li>
                ...
                <p>
                  ...
                  to the Klaviyo list you&apos;ve defined above.
                </p>
              </div>
            </div>
          </div>
