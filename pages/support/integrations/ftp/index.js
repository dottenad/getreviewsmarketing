...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Learn how to enable and configure the FTP integration here" />
    </Head>
                        ...
                        <li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 text-sm font-medium text-gray-500">FTP</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:gap-px">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            <div className="text-lg max-w-prose mx-auto">
                                <h1>
                                    <span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">FTP</span>
                                </h1>
                                <p className="mt-8 text-xl leading-8">The FTP integration allows you to upload your survey responses to a remote server.</p>
                                <img className="w-full my-8" src="../../../../ftp_instructions.png" alt=""  />
                            </div>
