                    ...
                    <div className="relative py-16 bg-white overflow-hidden">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-10 prose prose-sky prose-lg mx-auto">
                                ...
                                <h2>Integrations</h2>
                                Integrations is a two-part process. First, you will need to enable the integrations you would like to utilize on this survey in your <a href="https://app.getreviews.ai/integration/manage" target="_blank" className="underline">integrations library</a>. Once you have enabled the integrations you would like to utilize, return to your survey and you will notice an option has appeared for the integration(s) that you enabled. To enable an integration on your survey, you will need to tick the box next to the integration you would like to enable, and, if there are additional settings required by the integration, then you will need to fill these out as well. <mark><strong>Note:</strong></mark> Integrations fire conditionally based on the <a href="/support/getting-started/marketplaces#:~:text=What%20is%20a%20validation%20method%3F" target="_blank" className="underline">validation method</a> you have set for the marketplace of the completed survey. For example, if the customer is completing your survey for their Amazon purchase, and you have set Amazon to <strong>manual validation</strong>, then the integrations enabled on this survey will not fire until you have validated the customer's review. However, if Amazon is set to automatic validation and the customer enters an order number that exists in your order number database, then they are automatically validated and your integrations will fire immediately once the customer finishes the survey.
