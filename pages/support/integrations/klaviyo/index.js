...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Learn how to enable and configure the Klaviyo integration here" />
    </Head>
                    ...
                    <div className="rounded-tl-lg rounded-tr-lg relative group bg-white py-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-6 prose prose-lg prose-sky mx-auto text-gray-900">
                                ...
                                <ol>
                                    <li><a href="https://www.klaviyo.com/login" target="_blank" rel="noreferrer" className="underline">Log in</a> to your Klaviyo account</li>
                                    <li>Once logged in, visit <a href="https://www.klaviyo.com/account#api-keys-tab" target="_blank" rel="noreferrer" className="underline">https://www.klaviyo.com/account#api-keys-tab</a></li>
                                ...
                                <ol>
                                    <li>View your <a href="https://www.klaviyo.com/lists" target="_blank" rel="noreferrer" className="underline">Lists</a></li>
                                    ...
                                    <li>Your list&apos;s ID will be near the top of this screen (see image below)
                                        <figure className="mt-4">
                                            <img className="w-full rounded-lg border border-gray-200" src="../../../klaviyo_1.jpg" alt="" />
