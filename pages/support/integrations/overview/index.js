...
const SupportIndex = () => (
  <div>
    <Head>
      ...
      <meta name="description" content="Familiarize yourself with how integrations work within GetReviews" />
    </Head>
                    ...
                    <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:gap-px">
                        ...
                        <div className="relative px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-6 prose prose-lg mx-auto text-gray-900">
                                ...
                                <figure>
                                    <img className="w-full rounded-lg border border-gray-200" src="../../../integrations_1.jpg" alt="" />
                                ...
                                <figure>
                                    <img className="w-full rounded-lg border border-gray-200" src="../../../integrations_2.jpg" alt="" />
                                ...
                                <figure>
                                    <img className="w-full rounded-lg border border-gray-200" src="../../../integrations_3.jpg" alt="" />
                                ...
                                <figure>
                                    <img className="w-full rounded-lg border border-gray-200" src="../../../integrations_4.jpg" alt="" />
