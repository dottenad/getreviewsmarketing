                    ...
                    <div class="relative py-16 bg-white overflow-hidden">
                        ...
                        <div class="relative px-4 sm:px-6 lg:px-8">
                            <div class="text-lg max-w-prose mx-auto">
                                <h1>
                                    <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Coupon Code</span>
                                </h1>
                            </div>
                            <div class="mt-6 prose prose-indigo prose-lg mx-auto">
                                ...
                                <ol role="list">
                                    ...
                                    <li>Complete the fields to create a coupon giveaway<br /><img class="w-full rounded-lg mt-4" src="../../../create_coupon.jpg" alt="" width="1310" /></li>
                                    <ol>
