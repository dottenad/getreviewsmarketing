                        ...
                        <ol role="list" className="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <Link passHref href="/support/getting-started/giveaways" className="text-black hover:text-gray-700"><a class="ml-4 text-sm font-medium text-gray-500">Giveaways</a></Link>
                                </div>
                            </li>
