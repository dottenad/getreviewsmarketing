...
const SupportIndex = () => (
  <div>
    <Head>
      <title>Account Settings - GetReviews.ai</title>
      <meta
        name="description"
        content="View and configure additional account settings, including user/password administration, and more."
      />
    </Head>
          ...
          <div className="rounded-bl-lg rounded-br-lg relative group bg-white p-8 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-500">
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Learn how to ban specific order numbers at the account level
                  here.
                </p>
              </div>
            </div>
